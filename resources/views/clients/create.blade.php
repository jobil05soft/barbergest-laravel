<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('clients.store') }}" method="POST" class="space-y-4 bg-white p-6 rounded shadow">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" class="w-full border px-3 py-2" >
                </div>
                <div>
                    <button type="submit" class="px-4 py-2 bg-red-500 text-red-900 rounded hover:bg-green-600">Salvar</button>
                    <a href="{{ route('clients.index') }}" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Cancelar</a>
                </div>
            </form>
